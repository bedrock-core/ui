...
// Commented is out of scope for now and in consideration if will be implemented later
// Uncommented might not be added yet
...
// Max of 264 bytes (without anims)
// Will reserve in v1 serialization 320 bytes for future proofing
...
export interface LayoutProperties {
  // Only numbers for now, will need to make validator for string types
  ...
  // contained?: boolean;  // What does this even do?
  // draggable?: 'vertical' | 'horizontal' | 'both'; // idk if should be implemented
  // follows_cursor?: boolean; // idk if should be implemented
}

// Need to know what each of this does is it worth?
...
// Need to think a way to handle this states properly instead of passing instances for each variant
...
// Need to think a way to handle this controls, is like passing a child component for that specific property
...
export interface GridProperties {
  ...
  // grid_dimension_binding?: string; // What does this do?
