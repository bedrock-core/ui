...
- Order: width, height, x, y, visible, enabled, background, $reserved
- Applies defaults to optional props (visible=true, enabled=true, background=fallback texture, etc.)
- Reserves 501 bytes for future expansion (total 1024 bytes control block)
