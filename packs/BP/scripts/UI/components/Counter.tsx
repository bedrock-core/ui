...
export const Counter: FunctionComponent = (): JSX.Element => {
  ...
  return (
    <Panel width={220} height={140} x={240} y={160}>
      {/* Title */}
      <Text width={220} height={20} x={250} y={170} value={'§l§aCounter'} />

      {/* Display current count */}
      <Text width={220} height={20} x={250} y={195} value={`Count: §l${count}`} />

      {/* Auto-increment status */}
      <Text width={220} height={15} x={250} y={218} value={`Auto: ${isAutoIncrement ? '§aON' : '§cOFF'}`} />
      ...
      <Button
        ...
        <Text width={100} height={20} x={300} y={244} value={'§l+1'} />
      </Button>
      ...
      <Button
        ...
        <Text width={100} height={20} x={405} y={244} value={'§l-1'} />
      </Button>
      ...
      <Button
        ...
        <Text width={205} height={20} x={352} y={269} value={`§9${isAutoIncrement ? 'Stop' : 'Start'} Auto`} />
      </Button>
    </Panel>
  );
};
