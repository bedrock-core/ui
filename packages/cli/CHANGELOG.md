...
- [`44166cb`](https://github.com/bedrock-core/ui/commit/44166cb2b875158ff913ae8442b8e85ab4686fa3) Thanks [@drav0011](https://github.com/drav0011)! - `--version` now reports the CLI's real version, and the scaffolded project installs the server stack through the `@bedrock-core/server` meta package.
