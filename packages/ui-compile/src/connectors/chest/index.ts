 ...
 * only cross as numbers, one slot's stack size per character. Every mechanism
 * here is one of those two facts spelled out as JSON UI.
 */
...
export {
  containerItemVars, ensureForeignCell, foreignSlot, hidesTransport, slot,
