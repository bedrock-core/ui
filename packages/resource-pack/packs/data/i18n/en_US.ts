 ...
 * RP/texts/en_US.lang (keys prefixed `core.` (this pack IS bedrock-core family: real keys `core.ui.*`)), the runtime bundle, and the
...
export default {
  ui: {
    ...
    demo: {
      title: 'i18n Demo',
      intro: 'Every verb the library has, live: $t(ui.demo.title).',
